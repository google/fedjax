fedjax.experimental.metrics module
==================================

.. automodule:: fedjax.experimental.metrics
...
.. autosummary::
		...
		fedjax.experimental.metrics.Stat
		fedjax.experimental.metrics.MeanStat
		fedjax.experimental.metrics.SumStat
...
.. autosummary::
		...
		fedjax.experimental.metrics.Metric
		fedjax.experimental.metrics.CrossEntropyLoss
		fedjax.experimental.metrics.Accuracy
		fedjax.experimental.metrics.SequenceTokenCrossEntropyLoss
		fedjax.experimental.metrics.SequenceCrossEntropyLoss
		fedjax.experimental.metrics.SequenceTokenAccuracy
		fedjax.experimental.metrics.SequenceTokenCount
		fedjax.experimental.metrics.SequenceCount
		fedjax.experimental.metrics.SequenceTruncationRate
		fedjax.experimental.metrics.SequenceTokenOOVRate
		fedjax.experimental.metrics.SequenceLength
		fedjax.experimental.metrics.PerDomainMetric
...
.. autosummary::
		...
		fedjax.experimental.metrics.unreduced_cross_entropy_loss
		fedjax.experimental.metrics.evaluate_batch

Quick Overview
--------------

To evaluate model predictions, use a :class:`Metric` object such as :class:`Accuracy` .
We recommend :func:`fedjax.experimental.model.evaluate_model` in most scenarios,
...
for greater computational efficiency::
  ...
  results = fedjax.experimental.model.evaluate_model(model, params, batches)
  print(results)
  # {'accuracy': 0.75}
...
:func:`fedjax.experimental.model.evaluate_model` provides a simple way to do so.
...
:func:`fedjax.experimental.model.evaluate_model` .
...
.. autoclass:: fedjax.experimental.metrics.Stat
		:members:

.. autoclass:: fedjax.experimental.metrics.MeanStat
		:members: merge, new, reduce, result
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SumStat
		:members: merge, new, reduce, result
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.Metric
		:members:

.. autoclass:: fedjax.experimental.metrics.CrossEntropyLoss
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.Accuracy
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceTokenCrossEntropyLoss
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceCrossEntropyLoss
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceTokenAccuracy
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceTokenCount
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceCount
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceTruncationRate
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceTokenOOVRate
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.SequenceLength
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autoclass:: fedjax.experimental.metrics.PerDomainMetric
		:members: evaluate_example, zero
		:undoc-members:
		:show-inheritance:

.. autofunction:: fedjax.experimental.metrics.unreduced_cross_entropy_loss

.. autofunction:: fedjax.experimental.metrics.evaluate_batch
